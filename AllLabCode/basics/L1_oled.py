...
def getVoltage():
    ...
    ##########################################
    return voltz# Be sure to return your variable name for your getVoltage()
...
def displayText():
    ...
    draw.text((0, 00), "Maximus", font=font, fill=255)

    volty = getVoltage()
    draw.text((0,40), "Voltage: {:6.3f} V".format(volty), font=font, fill=255)
